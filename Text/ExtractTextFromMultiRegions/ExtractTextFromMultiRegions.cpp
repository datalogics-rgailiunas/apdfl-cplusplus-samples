...
bool CheckWithinRegion(ASFixedQuad wordQuad, std::vector<int> region);
...
bool CheckWithinRegion(ASFixedQuad wordQuad, std::vector<int> region) {
    ...
    ASFixed userTargetRegionFixedL = FloatToASFixed(region[left]);
    ASFixed userTargetRegionFixedR = FloatToASFixed(region[right]);
    ASFixed userTargetRegionFixedB = FloatToASFixed(region[bottom]);
    ASFixed userTargetRegionFixedT = FloatToASFixed(region[top]);
