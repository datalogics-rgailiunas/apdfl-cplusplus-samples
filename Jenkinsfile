...
pipeline {
    parameters {
        choice(name: 'PLATFORM_FILTER', choices: ['all', 'mac-apdfl-samples', 'aix-apdfl-samples', 'sparcsolaris-apdfl-samples', 'linux-apdfl-samples', 'windows-apdfl-samples'], description: 'Run on specific platform')
    }
    agent none
    triggers {
        ...
        stage('Matrix stage') {
            matrix {
                ...
                axes {
                    axis {
                        name 'NODE'
                        values 'mac-apdfl-samples', 'aix-apdfl-samples', 'sparcsolaris-apdfl-samples', 'windows-apdfl-samples', 'linux-apdfl-samples'
                    }
                    axis {
                        name 'BITS'
                        values '64', '32'
