...
CCFLAGS  = $(ARCH_FLAGS) -g $(PDF_FDIR_DEF) -DNO_PRAGMA_ONCE -DMAC_PLATFORM=1 -DMAC_ENV=1 -DPRODUCT=\"HFTLibrary.h\" $(DEBUG) -D_REENTRANT -Wno-multichar -DPDFL_SDK_SAMPLE -DPI_ACROCOLOR_VERSION=AcroColorHFT_VERSION_6 -DTOOLKIT

CXXFLAGS = -std=c++11 $(CCFLAGS)

LDFLAGS = $(ARCH_FLAGS) -Wl,-rpath,$(PDFL_PATH) -L$(PDFL_PATH)
