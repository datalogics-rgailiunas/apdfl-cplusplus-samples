...
{
public:
    APDFLib(char* dl100Dir);                          //Constructor initializes APDFL and sets the path to DL100PDFL.dll to dl100Dir. If NULL is passed, defaults to ../../Libs. dl100Dir should be a relative path.
...
private:
    ...
    ASInt32 loadDFL100PDFL(char* relativeDir);        //Loads the DL100PDFL library dynamically.
